...
<body style="background-color: var(--AlmostWhite); overflow-y: hidden;"> <!-- overflow: hidden; -->
    ...
    <div id="whereSidenavD">
        <div class="rounded-pill base pill" id="btnMyDraw" style="top: calc(45vh + 5rem); background-color: var(--AccentColor);" onmousedown='openDraw()'>
            <svg xmlns="http://www.w3.org/2000/svg" id="btnDraw" width="16" height="16" fill="var(--BaseColor)" class="bi bi-chevron-compact-left" viewBox="0 0 16 16">
        ...
        <div id="myDraw" class="sidenavDraw base" style="z-index: 9995; height: 100vh; max-height: 100vh; width: 70%; left: -70%; border-top-right-radius: 25px; border-bottom-right-radius: 25px; overflow-y: hidden;">
            ...
            <div class="shadow" id="caneta">
                ...
                <div>
                    <!-- empty -->
                    <svg id="eraserMT" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="basic_instruments bi bi-eraser eraser" viewBox="0 0 16 16" style="z-index:7;" onmousedown="{
                    ...
                    <!-- full -->
                    <svg id="eraserFull" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="basic_instruments bi bi-eraser-fill eraser" viewBox="0 0 16 16" style="z-index:6; opacity: 0;" onmousedown="{
                ...
                <div>
                    <!-- empty -->
                    <svg id="penMT" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="basic_instruments bi bi-pen pen" viewBox="0 0 16 16" style="z-index:7;" onmousedown="{
                    ...
                    <!-- full -->
                    <svg id="penFull" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="basic_instruments bi bi-pen-fill pen" viewBox="0 0 16 16" style="z-index:6; opacity: 0;" onmousedown="{
                        document.getElementById('penMT').style.opacity = '1';
                        document.getElementById('penFull').style.opacity = '0';
                        document.getElementById('penFull').style.zIndex = '6';
                        document.getElementById('penMT').style.zIndex = '7';
                ...
                <div style="width: 13vw; height: 100px; right: 1vw; top:45vh; position: absolute; padding-left: 1vw;">
                    ...
                    <button onmousedown="increaseSize(true);" class="BTNIncrease">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="var(--Black)" class="bi bi-chevron-up" viewBox="0 0 16 16" style="height:2.5vh; width: 2.5vh; transform: rotate(360deg); position: absolute; top: 0vh; left: 0.625vw;">
                            <path fill-rule="evenodd" d="M7.646 4.646a.5.5 0 0 1 .708 0l6 6a.5.5 0 0 1-.708.708L8 5.707l-5.646 5.647a.5.5 0 0 1-.708-.708l6-6z"/>
                        </svg>
                    </button>
                    
                    <button style="top: 8.5vh;" onmousedown="increaseSize(false)" class="BTNIncrease">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="var(--Black)" class="bi bi-chevron-up" viewBox="0 0 16 16" style="height: 2.5vh; width: 2.5vh; transform: rotate(180deg); position: absolute; top: 0vh; left: 0.625vw;">
                            <path fill-rule="evenodd" d="M7.646 4.646a.5.5 0 0 1 .708 0l6 6a.5.5 0 0 1-.708.708L8 5.707l-5.646 5.647a.5.5 0 0 1-.708-.708l6-6z"/>
                        </svg>
                    </button>
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="var(--BaseColor)" class="bi bi-x" viewBox="0 0 16 16" style="height: 2.5rem; width:2.5rem; top: 5vh; right: 0.5vw; cursor: pointer; float: right; position: absolute;" onmousedown="clearCanvas();"> 
    ...
    <div id="whereFooter">
        <div id="contato">
            ...
            <!-- <a href="http://www.twitter.com/tavicozampar" target="_blank" rel="noopener"><img src="../src/TwitterLogoBlue.svg" style="height: auto; width: 25px;"></a>
