...
function dataBarren() { // não possui option nem group, placeholders estão alterados
    var data = [
        { form: "doEval", qnt: 1, exit: 1, placeholder: ["calc"]},
        ...
        { form: "fatoracao", qnt: 1, exit: 1, placeholder: ["x"]  },
        { form: "Acirculo", qnt: 1, exit: 1, placeholder: ["r"]},
        { form: "Aretangulo", qnt: 2, exit: 1, placeholder: ["b", "h"] },
        { form: "Atriangulo", qnt: 2, exit: 1, placeholder: ["b", "h"] },
        { form: "AtrianguloEquilatero", qnt: 1, exit: 1, placeholder: ["l"] },
        { form: "Atrapezio", qnt: 3, exit: 1, placeholder: ["B", "b", "h"] },
        { form: "Alosango", qnt: 2, exit: 1, placeholder: ["D", "d"] },
        { form: "AanguloTriangulo", qnt: 3, exit: 1, placeholder: ["L", "l", "a"]  },
        { form: "Vcubo", qnt: 1, exit: 1, placeholder: ["l"]  },
        { form: "Vparalelepipedo", qnt: 3, exit: 1, placeholder: ["l", "c", "h"]  },
        { form: "Vcilindro", qnt: 2, exit: 1, placeholder: ["r", "h"]  },
        { form: "Vesfera", qnt: 1, exit: 1, placeholder: ["r"]  },
        { form: "Vcone", qnt: 2, exit: 1, placeholder: ["r", "h"]  },
        { form: "Vprisma", qnt: 2, exit: 1, placeholder: ["b", "h"]  },
        { form: "hipotenusa", qnt: 2, exit: 1, placeholder: ["C", "c"]  },
        { form: "cateto", qnt: 2, exit: 1, placeholder: ["c", "h"]  },
        { form: "perimetro", qnt: 2, exit: 1, placeholder: ["l", "s"]  },
        { form: "soma", qnt: 2, exit: 1, placeholder: ["x", "y"]  },
        { form: "subtracao", qnt: 2, exit: 1, placeholder: ["x", "y"]  },
        { form: "multiplicacao", qnt: 2, exit: 1, placeholder: ["x", "y"]  },
        { form: "divisao", qnt: 2, exit: 1, placeholder: ["x", "y"]  },
        { form: "Math.pow", qnt: 2, exit: 1, placeholder: ["b", "x"]  },
        { form: "raizQ", qnt: 2, exit: 1, placeholder: ["r", "i"]  },
        { form: "log", qnt: 1, exit: 1, placeholder: ["x"]  },
        { form: "log10", qnt: 1, exit: 1, placeholder: ["x"]  },
        { form: "log2", qnt: 1, exit: 1, placeholder: ["x"]  },
        { form: "inversao", qnt: 1, exit: 1, placeholder: ["x"]  },
        { form: "modulo", qnt: 1, exit: 1, placeholder: ["x"]  },
        { form: "Math.sin", qnt: 1, exit: 1, placeholder: ["s"]  },
        { form: "Math.cos", qnt: 1, exit: 1, placeholder: ["c"]  },
        { form: "Math.tan", qnt: 1, exit: 1, placeholder: ["t"]  },
        { form: "aleatorio", qnt: 2, exit: 1, placeholder: ["min", "max"] },
        { form: "bitShiftZL", qnt: 2, exit: 1, placeholder: ["x", "y"] },
        { form: "bitShiftSR", qnt: 2, exit: 1, placeholder: ["x", "y"] },
        { form: "bitShiftZR", qnt: 2, exit: 1, placeholder: ["x", "y"] },
        { form: "and", qnt: 2, exit: 1, placeholder: ["x", "y"] },
        { form: "or", qnt: 2, exit: 1, placeholder: ["x", "y"] },
        { form: "xor", qnt: 2, exit: 1, placeholder: ["x", "y"] },
        { form: "not", qnt: 1, exit: 1, placeholder: ["x"] },
        { form: "binario", qnt: 1, exit: 1, placeholder: ["x"] },
        { form: "hexadecimal", qnt: 1, exit: 1, placeholder: ["x"] },
        { form: "octal", qnt: 1, exit: 1, placeholder: ["x"] },
        { form: "base", qnt: 2, exit: 1, placeholder: ["x", "b"] },
        { form: "basePraDecimal", qnt: 2, exit: 1, placeholder: ["x", "b"] },
        // Adicione outras opções com mensagens personalizadas aqui
    ];
    return data;
}